    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="container-fluid">
                <?php
                    //dd(route('Managers.update'));
                ?>
                <form method="POST" action="<?php echo e(route('manager-update')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="phone_number" placeholder="Phone Number"
                                name="phone_number" required value="<?php echo e($manager->phone_number); ?>">
                        </div>
                    </div>
                    <div class="form-row">
                            ...
                            <div class="m-b-15">
                                <select class="select2" name="nrc_location" id="nrc_location" required>
                                    <?php $__currentLoopData = $nrc_numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nrc_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($manager->nrc_location == $nrc_number->prefix_en): ?>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select id="inputState" class="form-control" name="nrc_type" required>
                                <?php $__currentLoopData = $nrc_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nrc_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($nrc_type == $manager->nrc_type): ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="nrc_number" placeholder="NRC Number"
                                name="nrc_number" required value="<?php echo e($manager->nrc_number); ?>">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="Email" name="email" required
                                value="<?php echo e($manager->email); ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="address">Address</label>
                            <input type="text" class="form-control" id="address" placeholder="Apartment, studio, or floor" name="address" required value="<?php echo e($manager->address); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="industry" class="select2" name="industry">
                            <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($industry->industry); ?>"><?php echo e($industry->industry); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aungnaingphyoe/Desktop/Xsphere/workAtmosphere/wa-admin-backend/resources/views/owner/edit-manager.blade.php ENDPATH**/ ?>